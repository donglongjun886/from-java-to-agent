...
# ═══════════════ Document Specs（12 篇，9 元组精简定义） ═══════════════
# (text, tenant, access_level, intern, engineer, manager, source_type, doc_id, timestamp)

_DOCS = [
    # ── research: 3 public + 1 confidential ──
    ("Q3 2026 Financial Report: Revenue 38.2B CNY (+18% YoY), net profit 5.8B. Growth driven by cloud computing (+35%) and AI (+62%). Gross margin 48.2%, up from 45.1%. Q4 guidance 40-42B, full-year target 150B. Operating expenses +12% due to AI chip R&D expansion.",
     "research", "public", True, True, True, "pdf_report", "RES_PDF_001", "2026-06-20T09:00:00"),

    ("Semiconductor Industry Trend H1 2026: AI chip demand surged 45% YoY driven by LLM training infrastructure. Domestic substitution rate for 14nm+ processes reached 65% (48% in 2025). Key players: SMIC (28nm capacity +30%), Hua Hong (IGBT), YMTC (232-layer NAND). Risk: US EUV export controls, wafer price +8%. Overweight semiconductor equipment sector.",
     "research", "public", True, True, True, "pdf_report", "RES_PDF_002", "2026-06-18T14:00:00"),

    ("Company Fundamentals (2026-06-25): Market Cap 520B CNY, PE(TTM) 35.2, PB 4.8, PS 6.1. Revenue TTM 142B, Net Income 18.5B. ROE 18.5%, ROA 8.2%. D/E 0.45, Current Ratio 1.8, FCF 22B. Revenue CAGR(3yr) 22%, EPS CAGR 19%. Dividend yield 0.8%. Institutional ownership 62%.",
     "research", "public", True, True, True, "db_record", "RES_DB_001", "2026-06-25T16:30:00"),

    ("CONFIDENTIAL — Credit Risk Assessment Q2 2026: Three corporate clients downgraded to Watch, total exposure 2.4B CNY. Real estate sector exposure reduced from 15% to 8%. Counterparty risk for OTC derivatives with EU banks elevated due to Basel IV uncertainty. Provision coverage increase from 2.1% to 2.8% by Q4 2026.",
    ...
    ("H2 2026 Market Outlook: A-share SSE Composite 3200-3600 range, CSI 300 target 4200-4500. Overweight financials (banks+insurers), underweight real estate. Catalysts: PBOC RRR cut (expected Q3), SOE reform acceleration, northbound capital recovery. Risk: US election tariff policy shift.",
     "trading", "public", True, True, True, "pdf_report", "TRD_PDF_001", "2026-06-24T10:00:00"),

    ("Real-time Market Data (2026-06-25 15:00 CST): CSI 300 3958.2 (+1.2%), SSE Composite 3356.7 (+0.8%), SZSE Component 10820.5 (+1.5%), ChiNext 2150.3 (+1.8%), HSI 19820.5 (-0.3%), HSCEI 7120.3 (+0.2%). FX: USD/CNY 7.12, EUR/CNY 7.78. Commodities: Gold 2350 USD/oz, Brent 82.5 USD/bbl.",
     "trading", "public", True, True, True, "api_json", "TRD_API_001", "2026-06-25T15:00:00"),

    ("CONFIDENTIAL — Position Summary (2026-06-25): Total AUM 8.5B CNY. Allocation: Tech 35%, Financials 25%, Consumer 18%, Healthcare 12%, Energy 10%. Top 3: CITIC Securities 1.2B (cost 22.5), Moutai 0.95B (cost 1680), CATL 0.82B (cost 195). Unrealized P&L +380M YTD. Leverage 1.15x (limit 1.5x).",
     "trading", "confidential", False, True, True, "db_record", "TRD_DB_001", "2026-06-25T18:00:00"),

    ("CONFIDENTIAL — Quantitative Trading Signal (2026-06-25 14:30): BUY 600036 CMB. Multi-factor confidence 0.87. Technical: MACD golden cross, RSI(14)=42 (oversold bounce), volume 1.8x avg. Target 45.2 (+15% from 39.3), stop 36.5 (-7%). Signal expires 48h. Position sizing: 2% of AUM.",
    ...
    ("Audit Trail Summary Q2 2026: 12,847 trades reviewed. 3 flagged: Desk B 2026-04-15 (suspected wash trading, 85M CNY), Desk A 2026-05-02 (cross-exchange manipulation, 120M CNY), Desk C 2026-05-20 (unauthorized algo parameter change). Compliance score 94.2/100 (below 95 target).",
     "compliance", "public", True, True, True, "db_record", "CMP_DB_001", "2026-06-23T14:00:00"),

    ("OFAC SDN List Update (2026-06-24): 6 entities added, 2 applicable to APAC network. Entity A: Shanghai shipping co. (DPRK sanctions evasion). Entity B: HK trading firm (Iran oil). Required: freeze assets, block transactions, file SAR 30 days. Existing exposure: zero.",
     "compliance", "public", True, True, True, "api_json", "CMP_API_001", "2026-06-25T08:00:00"),

    ("CONFIDENTIAL — Internal Investigation Case 2026-07: Trader at Desk B (ID TRD-3421) executed unauthorized cross-border transfer 5M USD to Cayman Islands entity on 2026-05-28, bypassing internal approval. Root cause: dual-control disabled during system upgrade. Recommend: immediate termination, mandatory 4-eyes for transfers >1M, revoke Desk B supervisor license.",
