...
### 24.2 Function Calling / Tool Use 原理
...
### 24.3 MCP 协议（Model Context Protocol）
...
### 24.4 框架选型：LangChain vs LangGraph vs CrewAI
...
### 24.7 为什么 Java 工程师转型 Agent 有优势（面试核心卖点）
